...
<head>
    ...
    <link rel="stylesheet" href="../style/success.css">
            ...
            <!-- <nav class="navbar">
                ...
                <li class="nav-link">Purchase</li>
                <li class="nav-link">Login</li>
            </nav> -->
                        <!-- <a href="" class="a-link">
                <span class="total-notification">5</span>
                <ion-icon name="log-out-outline" class="notification-icon"></ion-icon>
            </a> -->
                        
            <!-- <a href="" class="a-link"> -->
                <!-- <span class="total-item">10</span> -->
                <!-- <ion-icon name="cart-outline" class="cart-icon"></ion-icon> -->
                <!-- <ion-icon name="bag-outline" class="notification-icon"></ion-icon> -->
            <!-- </a> -->
<body>
    ...
    <div class="categories-bar">
        <nav class="categories-nav">
            ...
            <!-- <li class="category-link">
                <a href="" style="text-decoration: none; color: #000;">Tops</a>
            </li>
            <li class="category-link">
                <a href="" style="text-decoration: none; color: #000;">Tops</a> -->
            </li>
    ...
    <div class="item-container">
        <div class="card">
            ...
            <div class="card-image">
                <img src="../image/shoes3.png" alt="" class="image-item">
            </div>
        ...
        <div class="card">
            ...
            <div class="card-image">
                <img src="../image/shirt2.png" alt="" class="image-item">
            </div>
        ...
        <div class="card">
            ...
            <div class="card-image">
                <img src="../image/shirt3.png" alt="" class="image-item">
            </div>
        ...
        <div class="card">
            ...
            <div class="card-image">
                <img src="../image/shoes2.png" alt="" class="image-item">
            </div>
        ...
        <div class="card">
            ...
            <div class="card-image">
                <img src="../image/shirt1.png" alt="" class="image-item">
            </div>
        ...
        <div class="card">
            ...
            <div class="card-image">
                <img src="../image/shoes1.png" alt="" class="image-item">
            </div>
        ...
        <div class="card">
            ...
            <div class="card-image">
                <img src="../image/heel1.png" alt="" class="image-item">
            </div>
